...
export default function rotateArrayNTimes(arr: number[], k: number): number[] {
  if (arr.length === 0) {
    return arr;
  }
...
console.log(rotateArrayNTimes([3, 8, 9, 7, 6], 3)); // [9, 7, 6, 3, 8]
console.log(rotateArrayNTimes([0, 0, 0], 1)); // [0, 0, 0]
console.log(rotateArrayNTimes([1, 2, 3, 4], 4)); // [1, 2, 3, 4]
console.log(rotateArrayNTimes([], 4)); // []
console.log(rotateArrayNTimes([1, 2, 3, 4], 0)); // [1, 2, 3, 4]
